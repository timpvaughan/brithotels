        ...
        <div class="hotel-thumb">
			<?php
				...
				if($featured_image !== false){
					...
					?>
					<img src="<?php echo $featured_image; ?>" class="img-fluid" alt="Earls Court hotel" />
					<?php
				}
				else{
					?>
					<img src="<?php echo get_template_directory_uri(); ?>/assets/images/hotel/1.jpg" class="img-fluid" alt="Earls Court hotel" />
					<?php
				}
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="about-hotel">
                        <h3><?php esc_html_e('Earls Court', 'brithotels' ); ?></h3>
