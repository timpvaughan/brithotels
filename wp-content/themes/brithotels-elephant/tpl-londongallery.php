...
?>
	<div id="primary" class="content-area">
		<main id="main" class="site-main">
            ...
            <?php
            $location_page = intval(get_field('brithotels_page_location', 'option'));
            $location_page_url = ($location_page > 0) ? get_permalink($location_page) : '#';
            ?>
            <div class="black-bg pt100 pb100">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="next-page">
                                <h2><?php esc_html_e('Locate Us', 'brithotels'); ?></h2>
                                <a href="<?php echo esc_url($location_page_url); ?>"><?php esc_html_e('Click Here', 'brithotels'); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
