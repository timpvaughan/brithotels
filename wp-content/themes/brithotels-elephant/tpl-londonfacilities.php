				...
				<div class="container">
					<div class="row">
						<div class="feature-2-wrap">
							...
							<div class="feature-2">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/london-icon.svg" class="img-fluid" alt="">
								<h5>Centrally Located</h5>
								<p>Conveniently located to everything London has to offer</p>
							</div>
							<div class="feature-2">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/reception-icon.svg" class="img-fluid" alt="">
								<h5>Friendly Staff</h5>
								<p>Our helpful and knowledgeable team members are on hand to assist you</p>
							</div>
							<div class="feature-2">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/cleaning-icon.svg" class="img-fluid" alt="">
								<h5>Cleanliness</h5>
								<p>Brit Hotels upholds the highest of standards for cleanliness and sanitation</p>
							</div>
							<div class="feature-2">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/lift-icon.svg" class="img-fluid" alt="">
								<h5>Lift</h5>
								<p>8 Person DDA Compliant Lift</p>
							</div>
							<div class="feature-2">
								<img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon/no-smoking-icon.svg" class="img-fluid" alt="">
								<h5>Non-Smoking</h5>
								<p>For your comfort all Brit Hotels premises are Non-Smoking</p>
							</div>
						</div>
					</div>
				</div>
