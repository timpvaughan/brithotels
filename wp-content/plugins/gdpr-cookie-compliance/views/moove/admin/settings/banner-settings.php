		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<p class="description" id="moove_gdpr_settings_button_enable-description" ><?php esc_html_e( "Settings button opens up the Cookie Settings Screen.", 'gdpr-cookie-compliance' ); ?></p>
					<!--  .description -->
				</td>
			</tr>
