...
function wpgmza_pro_return_category_select_list($map_id, $selected_category=null) {
    global $wpdb;
    global $wpgmza_tblname_categories;
    global $wpgmza_tblname_category_maps;
    $ret_msg = "";
    ...
    wpgmza_consume_tree_dropdown($tree, "", $map_id, '', $selected_category);
...
function wpgmza_pro_return_category_checkbox_list($map_id,$show_all = true,$array = false, $selected_category=null) {
    global $wpdb;
    global $wpgmza_tblname_categories;
    global $wpgmza_tblname_category_maps;
    ...
    wpgmza_consume_tree($tree, $array_suffix, $map_id, $selected_category);
...
function wpgmza_consume_tree(array $array,$array_suffix,$map_id, $selected_category=null) {
    ...
    foreach($array as $key => $value){
        ...
        $wpmgza_cat_tree_html .= "<input type='checkbox' class='wpgmza_checkbox' id='wpgmza_cat_checkbox_".$value['id']."' name='wpgmza_cat_checkbox".$array_suffix."' mid=\"".$map_id."\" value=\"".$value['id']."\" $checked/>";
        ...
        if(is_array($value['children'])){
            wpgmza_consume_tree($value['children'], $array_suffix, $map_id, $selected_category);
        }
...
function wpgmza_consume_tree_dropdown(array $array,$array_suffix,$map_id, $ext_string = '', $selected_category=null) {
    ...
    foreach($array as $key => $value){
        ...
        $wpmgza_cat_tree_html .= "<option value=\"".$value['id']."\" $selected>".$ext_string.stripslashes($value['title'])." ".wpgmza_return_marker_count_category_via_elements(array(0=>$value), $wpgmza_settings)."</option>";
