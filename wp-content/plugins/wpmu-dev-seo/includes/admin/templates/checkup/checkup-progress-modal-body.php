...
if ( ! $is_member ) {
	$this->_render( 'mascot-message', array(
		...
		'message'     => sprintf(
			'%s <a target="_blank" class="sui-button sui-button-purple" href="https://premium.wpmudev.org/project/smartcrawl-wordpress-seo/?utm_source=smartcrawl&utm_medium=plugin&utm_campaign=smartcrawl_seocheckup_modal_upsell_notice">%s</a>',
