		...
		<div class="sui-box" role="document">
			<div class="sui-box-header sui-flatten sui-content-center sui-spacing-top--40">
				...
				<h3 class="sui-box-title sui-lg"
					...
					<?php esc_html_e( 'New! WooCommerce SEO', 'wds' ); ?>
				</h3>
				...
				<div class="sui-box-body">
					<p class="sui-description"
					   id="<?php echo esc_attr( $id ); ?>-dialog-description">
						<span>
							<?php printf(
								esc_html__( "Hey, %s! Do you sell products on your site with WooCommerce? Then say hello to SmartCrawl’s new WooCommerce SEO compatibility! With WooCommerce SEO, you can optimize your site for search engines and stand out from the crowd by including the required metadata and product schema.", 'wds' ),
