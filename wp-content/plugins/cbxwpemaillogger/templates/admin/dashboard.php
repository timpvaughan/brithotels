...
?>
<?php
$plugin_url = CBXWPEmailLoggerHelper::url_utmy( 'https://codeboxr.com/product/cbx-email-logger-for-wordpress/' );
$doc_url    = CBXWPEmailLoggerHelper::url_utmy( 'https://codeboxr.com/product/cbx-email-logger-for-wordpress/' );
?>
<div class="wrap">
    <div class="cbx-backend_container_header">
        <div class="cbx-backend_wrapper cbx-backend_header_wrapper">
            <div class="menu-heading">
                <img title="CBX Email logger - Helps & Updates" src="<?php echo CBXWPEMAILLOGGER_ROOT_URL . 'assets/images/icon_log.svg'
				?>" alt="CBX Email logger - Helps & Updates" width="32" height="32">
                <h2 class="wp-heading-inline wp-heading-inline-setting">
					<?php esc_html_e( 'CBX Email logger - Helps & Updates', 'cbxwpemaillogger' ); ?>
                </h2>
            </div>
            <a href="<?php echo admin_url() . 'admin.php?page=cbxwpemailloggersettings' ?>" class="button button-primary
            save-settings"> <?php esc_html_e( 'Go to Settings', 'cbxchangelog' ); ?><img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABgAAAAYCAYAAADgdz34AAAABmJLR0QA/wD/AP+gvaeTAAAARUlEQVRIie3PoQoAIBRD0eGPa3x/bJxF0GLbgrBThd0nEBFSJMsdoDXCo14PSgUAzfYdYMoXr+u7fPwKeMZ3YNjGIz62APJohRdPxDxbAAAAAElFTkSuQmCC"/></a>
        </div>
    </div>
            ...
            <div class="cbx-backend-row">
                <div class="cbx-backend-col col-xs-12 col-md-6 text-xs-left">
                                        ...
                                        <div class="feature-card-body static">
                                            <div class="feature-card-header">
                                                <a href="<?php echo esc_url( $plugin_url ); ?>"
                                                   target="_blank"> <img src="https://codeboxr.com/wp-content/uploads/productshots/14571-profile.png"
                                                                         alt="CBX Email logger for WordPress"/> </a>

                                            </div>
                                            <div class="feature-card-description">
                                                <h3>
                                                    <a href="<?php echo esc_url( $plugin_url ); ?>"
                                                       target="_blank">CBX Email logger Pro Addon</a></h3>
                                                <p>Pro features for CBX Email logger plugin.</p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="cbx-backend-card dashboard-plugin-Integration">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e( 'Third Party plugin Integration', 'cbxwpemaillogger' ); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            ...
                            <div class="cbx-backend-settings-row">
                                <p>
			                        ...
			                        <?php esc_html_e( 'Contact Form (integration for your plugin)', 'cbxwpemaillogger' ); ?></p>
                            </div>
                        </div>
							...
							if ( function_exists( 'fetch_feed' ) ) {
								...
								if ( ! is_wp_error( $feed ) ) : $feed->init();
									...
									foreach ( $blocks as $block ) {
										...
										$url = CBXWPEmailLoggerHelper::url_utmy( $url ); ?>
                                        <div class="cbx-backend-settings-row">
                ...
                <div class="cbx-backend-col col-xs-12 col-md-6 text-xs-left">
                        ...
                        <div class="content">
                            <div class="cbx-backend-settings-row">
                                <a href="https://codeboxr.com/contact-us" target="_blank">
									...
									<?php esc_html_e( 'Access our Premium Support', 'cbxwpemaillogger' ); ?></a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="mailto:info@codeboxr.com&subject=Need%20support%20for%20CBX%20WP%20Email%20logger" target="_blank">
									...
									<?php esc_html_e( 'Quick Support (Email)', 'cbxwpemaillogger' ); ?></a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="<?php echo esc_url( $plugin_url ); ?>" target="_blank">
									...
									<?php esc_html_e( 'CBX Email logger Plugin Information', 'cbxwpemaillogger' ); ?> </a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="<?php echo esc_url( $doc_url ); ?>" target="_blank">
									...
									<?php esc_html_e( 'Read the CBX Email logger User Guide', 'cbxwpemaillogger' ); ?> </a>
                            </div>
                            <div class="cbx-backend-settings-row">
                                <a href="https://wordpress.org/support/plugin/cbxwpemaillogger/reviews/#new-post" target="_blank">
									...
									<?php esc_html_e( 'Rate Our Plugin', 'cbxwpemaillogger' ); ?> </a>
                            </div>
                        </div>
                    ...
                    <div class="cbx-backend-card dashboard-changelog">
                        <div class="header">
                            <div class="text">
                                <h2><?php esc_html_e( 'Changelog', 'cbxwpemaillogger' ); ?></h2>
                            </div>
                        </div>
                        <div class="content">
                            <div class="cbx-backend-settings-row">
                                ...
                                <ul>
                                    <li><strong>[improvement]</strong> Setting page style improvement.</li>
                                    <li><strong>[Fixed]</strong> Help & setting page header issue fixed (on scroll).</li>
                            ...
                            <div class="cbx-backend-settings-row">
                                ...
                                <ul>
                                    <li><strong>[improvement]</strong> Plugin setting and other pages ui improvements (New Look).</li>
                                    <li><strong>[added]</strong> Add new menu helps & update.</li>
                                    <li><strong>[added]</strong> Plugin's compatibility with latest wp version.</li>
                            ...
                            <div class="cbx-backend-settings-row">
                                ...
                                <ul>
                                    <li><strong>[updated]</strong> Minor improvement.</li>
                                </ul>
                            </div>
                        </div>
                    </div><!--End Changelog-->
