<?php
	...
	class CBXWPEmailLogger {
		...
		private function define_admin_hooks() {
			...
			$this->loader->add_action( 'admin_init', $plugin_admin, 'email_testing_submit' );
			...
			$this->loader->add_action( 'wp_mail_failed', $plugin_admin, 'email_sent_failed', 10, 2 );
			//$this->loader->add_action( 'bp_send_email_failure', $plugin_admin, 'email_sent_failed', 10, 2 );
			...
			//$this->loader->add_filter( 'bp_phpmailer_init', $plugin_admin, 'phpmailer_init_extend', 99999 );
			...
			$this->loader->add_action( 'wp_dashboard_setup', $dashboard_widget, 'dashboard_widget' );
			...
			$this->loader->add_action( 'wp_ajax_cbxwpemaillogger_add_new_field', $plugin_admin, 'add_new_repeat_field' ); //add new repeat field
