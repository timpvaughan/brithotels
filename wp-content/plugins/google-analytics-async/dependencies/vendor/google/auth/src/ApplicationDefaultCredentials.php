...
class ApplicationDefaultCredentials
{
     ...
     * @throws DomainException if no implementation can be obtained.
     */
    public static function getCredentials($scope = null, callable $httpHandler = null, array $cacheConfig = null, \Beehive\Psr\Cache\CacheItemPoolInterface $cache = null, $quotaProject = null, $defaultScope = null)
    {
        $creds = null;
        ...
        if (!\is_null($jsonKey)) {
            ...
            $creds = \Beehive\Google\Auth\CredentialsLoader::makeCredentials($scope, $jsonKey, $defaultScope);
            ...
            $creds = new \Beehive\Google\Auth\Credentials\AppIdentityCredentials($anyScope);
        } elseif (self::onGce($httpHandler, $cacheConfig, $cache)) {
            $creds = new \Beehive\Google\Auth\Credentials\GCECredentials(null, $anyScope, null, $quotaProject);
        }
        if (\is_null($creds)) {
