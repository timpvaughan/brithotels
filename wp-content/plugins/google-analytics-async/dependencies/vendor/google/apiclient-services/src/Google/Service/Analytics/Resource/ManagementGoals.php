 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_ManagementGoals extends \Beehive\Google_Service_Resource
{
    /**
     ...
     * @return Google_Service_Analytics_Goal
     */
    public function insert($accountId, $webPropertyId, $profileId, \Beehive\Google_Service_Analytics_Goal $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_Goal
     */
    public function patch($accountId, $webPropertyId, $profileId, $goalId, \Beehive\Google_Service_Analytics_Goal $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_Goal
     */
    public function update($accountId, $webPropertyId, $profileId, $goalId, \Beehive\Google_Service_Analytics_Goal $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'goalId' => $goalId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('Beehive\\Google_Service_Analytics_Resource_ManagementGoals', 'Google_Service_Analytics_Resource_ManagementGoals', \false);