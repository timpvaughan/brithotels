 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_ManagementProfileUserLinks extends \Beehive\Google_Service_Resource
{
    /**
     ...
     */
    public function insert($accountId, $webPropertyId, $profileId, \Beehive\Google_Service_Analytics_EntityUserLink $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_EntityUserLink
     */
    public function update($accountId, $webPropertyId, $profileId, $linkId, \Beehive\Google_Service_Analytics_EntityUserLink $postBody, $optParams = array())
    {
 ...
 *  </code>
 */
\class_alias('Beehive\\Google_Service_Analytics_Resource_ManagementProfileUserLinks', 'Google_Service_Analytics_Resource_ManagementProfileUserLinks', \false);