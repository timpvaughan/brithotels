 ...
 *  </code>
 */
class Google_Service_PeopleService_Resource_People extends \Beehive\Google_Service_Resource
{
    /**
     ...
     */
    public function createContact(\Beehive\Google_Service_PeopleService_Person $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_PeopleService_Person
     */
    public function updateContact($resourceName, \Beehive\Google_Service_PeopleService_Person $postBody, $optParams = array())
    {
     ...
     */
    public function updateContactPhoto($resourceName, \Beehive\Google_Service_PeopleService_UpdateContactPhotoRequest $postBody, $optParams = array())
    {
        $params = array('resourceName' => $resourceName, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('Beehive\\Google_Service_PeopleService_Resource_People', 'Google_Service_PeopleService_Resource_People', \false);