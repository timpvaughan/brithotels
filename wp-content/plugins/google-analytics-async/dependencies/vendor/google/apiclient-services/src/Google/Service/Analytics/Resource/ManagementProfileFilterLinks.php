 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_ManagementProfileFilterLinks extends \Beehive\Google_Service_Resource
{
    /**
     ...
     * @return Google_Service_Analytics_ProfileFilterLink
     */
    public function insert($accountId, $webPropertyId, $profileId, \Beehive\Google_Service_Analytics_ProfileFilterLink $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_ProfileFilterLink
     */
    public function patch($accountId, $webPropertyId, $profileId, $linkId, \Beehive\Google_Service_Analytics_ProfileFilterLink $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_ProfileFilterLink
     */
    public function update($accountId, $webPropertyId, $profileId, $linkId, \Beehive\Google_Service_Analytics_ProfileFilterLink $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'profileId' => $profileId, 'linkId' => $linkId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('Beehive\\Google_Service_Analytics_Resource_ManagementProfileFilterLinks', 'Google_Service_Analytics_Resource_ManagementProfileFilterLinks', \false);