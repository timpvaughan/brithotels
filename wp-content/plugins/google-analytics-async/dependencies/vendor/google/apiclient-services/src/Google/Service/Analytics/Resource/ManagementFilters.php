 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_ManagementFilters extends \Beehive\Google_Service_Resource
{
    /**
     ...
     * @return Google_Service_Analytics_Filter
     */
    public function insert($accountId, \Beehive\Google_Service_Analytics_Filter $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_Filter
     */
    public function patch($accountId, $filterId, \Beehive\Google_Service_Analytics_Filter $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_Filter
     */
    public function update($accountId, $filterId, \Beehive\Google_Service_Analytics_Filter $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'filterId' => $filterId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('Beehive\\Google_Service_Analytics_Resource_ManagementFilters', 'Google_Service_Analytics_Resource_ManagementFilters', \false);