 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_ManagementCustomMetrics extends \Beehive\Google_Service_Resource
{
    /**
     ...
     * @return Google_Service_Analytics_CustomMetric
     */
    public function insert($accountId, $webPropertyId, \Beehive\Google_Service_Analytics_CustomMetric $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_CustomMetric
     */
    public function patch($accountId, $webPropertyId, $customMetricId, \Beehive\Google_Service_Analytics_CustomMetric $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_CustomMetric
     */
    public function update($accountId, $webPropertyId, $customMetricId, \Beehive\Google_Service_Analytics_CustomMetric $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'customMetricId' => $customMetricId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('Beehive\\Google_Service_Analytics_Resource_ManagementCustomMetrics', 'Google_Service_Analytics_Resource_ManagementCustomMetrics', \false);