 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_ManagementWebPropertyAdWordsLinks extends \Beehive\Google_Service_Resource
{
    /**
     ...
     * @return Google_Service_Analytics_EntityAdWordsLink
     */
    public function insert($accountId, $webPropertyId, \Beehive\Google_Service_Analytics_EntityAdWordsLink $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_EntityAdWordsLink
     */
    public function patch($accountId, $webPropertyId, $webPropertyAdWordsLinkId, \Beehive\Google_Service_Analytics_EntityAdWordsLink $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_EntityAdWordsLink
     */
    public function update($accountId, $webPropertyId, $webPropertyAdWordsLinkId, \Beehive\Google_Service_Analytics_EntityAdWordsLink $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'webPropertyAdWordsLinkId' => $webPropertyAdWordsLinkId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('Beehive\\Google_Service_Analytics_Resource_ManagementWebPropertyAdWordsLinks', 'Google_Service_Analytics_Resource_ManagementWebPropertyAdWordsLinks', \false);