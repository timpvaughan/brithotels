 ...
 *  </code>
 */
class Google_Service_Analytics_Resource_ManagementWebproperties extends \Beehive\Google_Service_Resource
{
    /**
     ...
     * @return Google_Service_Analytics_Webproperty
     */
    public function insert($accountId, \Beehive\Google_Service_Analytics_Webproperty $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_Webproperty
     */
    public function patch($accountId, $webPropertyId, \Beehive\Google_Service_Analytics_Webproperty $postBody, $optParams = array())
    {
     ...
     * @return Google_Service_Analytics_Webproperty
     */
    public function update($accountId, $webPropertyId, \Beehive\Google_Service_Analytics_Webproperty $postBody, $optParams = array())
    {
        $params = array('accountId' => $accountId, 'webPropertyId' => $webPropertyId, 'postBody' => $postBody);
        $params = \array_merge($params, $optParams);
 ...
 *  </code>
 */
\class_alias('Beehive\\Google_Service_Analytics_Resource_ManagementWebproperties', 'Google_Service_Analytics_Resource_ManagementWebproperties', \false);