 ...
 */
class AppendStream implements \Beehive\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\Beehive\Psr\Http\Message\StreamInterface $stream)
    {
    ...
    {
        return \Beehive\GuzzleHttp\Psr7\Utils::copyToString($this);
    }
    /**
