 ...
 */
function str(\Beehive\Psr\Http\Message\MessageInterface $message)
{
    return \Beehive\GuzzleHttp\Psr7\Message::toString($message);
}
/**
...
{
    return \Beehive\GuzzleHttp\Psr7\Utils::uriFor($uri);
}
/**
...
{
    return \Beehive\GuzzleHttp\Psr7\Utils::streamFor($resource, $options);
}
/**
...
{
    return \Beehive\GuzzleHttp\Psr7\Header::parse($header);
}
/**
...
{
    return \Beehive\GuzzleHttp\Psr7\Header::normalize($header);
}
/**
 ...
 */
function modify_request(\Beehive\Psr\Http\Message\RequestInterface $request, array $changes)
{
    return \Beehive\GuzzleHttp\Psr7\Utils::modifyRequest($request, $changes);
}
/**
 ...
 */
function rewind_body(\Beehive\Psr\Http\Message\MessageInterface $message)
{
    \Beehive\GuzzleHttp\Psr7\Message::rewindBody($message);
}
/**
...
{
    return \Beehive\GuzzleHttp\Psr7\Utils::tryFopen($filename, $mode);
}
/**
 ...
 */
function copy_to_string(\Beehive\Psr\Http\Message\StreamInterface $stream, $maxLen = -1)
{
    return \Beehive\GuzzleHttp\Psr7\Utils::copyToString($stream, $maxLen);
}
/**
 ...
 */
function copy_to_stream(\Beehive\Psr\Http\Message\StreamInterface $source, \Beehive\Psr\Http\Message\StreamInterface $dest, $maxLen = -1)
{
    return \Beehive\GuzzleHttp\Psr7\Utils::copyToStream($source, $dest, $maxLen);
}
/**
 ...
 */
function hash(\Beehive\Psr\Http\Message\StreamInterface $stream, $algo, $rawOutput = \false)
{
    return \Beehive\GuzzleHttp\Psr7\Utils::hash($stream, $algo, $rawOutput);
}
/**
 ...
 */
function readline(\Beehive\Psr\Http\Message\StreamInterface $stream, $maxLength = null)
{
    return \Beehive\GuzzleHttp\Psr7\Utils::readLine($stream, $maxLength);
}
/**
...
{
    return \Beehive\GuzzleHttp\Psr7\Message::parseRequest($message);
}
/**
...
{
    return \Beehive\GuzzleHttp\Psr7\Message::parseResponse($message);
}
/**
...
{
    return \Beehive\GuzzleHttp\Psr7\Query::parse($str, $urlEncoding);
}
/**
...
{
    return \Beehive\GuzzleHttp\Psr7\Query::build($params, $encoding);
}
/**
...
{
    return \Beehive\GuzzleHttp\Psr7\MimeType::fromFilename($filename);
}
/**
...
{
    return \Beehive\GuzzleHttp\Psr7\MimeType::fromExtension($extension);
}
/**
...
{
    return \Beehive\GuzzleHttp\Psr7\Message::parseMessage($message);
}
/**
...
{
    return \Beehive\GuzzleHttp\Psr7\Message::parseRequestUri($path, $headers);
}
/**
 ...
 */
function get_message_body_summary(\Beehive\Psr\Http\Message\MessageInterface $message, $truncateAt = 120)
{
    return \Beehive\GuzzleHttp\Psr7\Message::bodySummary($message, $truncateAt);
}
/**
...
{
    return \Beehive\GuzzleHttp\Psr7\Utils::caselessRemove($keys, $data);
}