 ...
 */
class FnStream implements \Beehive\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\Beehive\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
