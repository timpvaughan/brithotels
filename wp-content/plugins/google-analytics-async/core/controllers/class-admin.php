...
class Admin extends Base {
	...
	public function action_links( $links ) {
		...
		if ( ! beehive_analytics()->is_pro() || 'upgrade' === $membership ) {
			$custom['upgrade'] = '<a href="https://premium.wpmudev.org/hub/account/?utm_source=beehive&utm_medium=plugin&utm_campaign=beehive_pluginlist_upgrade" aria-label="' . esc_attr( __( 'Upgrade to Beehive Pro', 'ga_trans' ) ) . '" target="_blank" style="color: #8D00B1;">' . esc_html__( 'Upgrade', 'ga_trans' ) . '</a>';
